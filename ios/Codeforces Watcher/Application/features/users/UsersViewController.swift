...
class UsersViewController: UIViewControllerWithFab, ReKampStoreSubscriber {
    ...
    private func setupTableView() {
        ...
        [LoginTableViewCell.self, VerifyTableViewCell.self, UserTableViewCell.self, UserAccountTableViewCellNew.self, NoItemsTableViewCell.self, TitleSectionTableViewCell.self].forEach(tableView.registerForReuse(cellType:))
